-- Vodkach D1 account approval + friends schema
-- Run this in Cloudflare D1 Console after 0002_text_chats_messages.sql.
-- Important: run once. SQLite/D1 can error if ALTER ADD COLUMN is repeated.

PRAGMA foreign_keys = ON;

ALTER TABLE users ADD COLUMN access_status TEXT NOT NULL DEFAULT 'pending';
ALTER TABLE users ADD COLUMN requested_at TEXT NOT NULL DEFAULT (datetime('now'));
